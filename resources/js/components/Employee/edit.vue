        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form @submit.prevent="empEdit" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Status</label>
                                        <select v-model="form.status" class="form-control selectric">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button class="btn btn-info"><i class="fas fa-edit"></i> Update Employee</button>
                                    </div>
                                </div>
                            </div>
                        </form>
